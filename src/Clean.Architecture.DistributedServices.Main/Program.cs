...
using Clean.Architecture.DistributedServices.Main;
using Serilog;
using FastEndpoints;
...
builder.Services.AddW3CLogging(logging =>
{
  ...
  //logging.FileName = "Clean.Architecture.DS" + DateTime.UtcNow.ToString("yyyyMMdd");
  logging.LogDirectory = @"D:\\Logs\\Clean.Architecture\\ds_w3clogs";
