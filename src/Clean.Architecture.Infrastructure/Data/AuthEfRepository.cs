...
public class AuthEfRepository<T> : RepositoryBase<T>, IReadRepository<T>, IRepository<T> where T : class, IAggregateRoot
{
  private readonly ApplicationDbContext _dbContext;
  private readonly IMapper _mapper;

  public AuthEfRepository(ApplicationDbContext dbContext, IMapper mapper) : base(dbContext)
  {
