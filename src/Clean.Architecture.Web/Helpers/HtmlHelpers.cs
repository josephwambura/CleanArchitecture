...
public static class HtmlHelpers
{
  public static string IsSelected(this IHtmlHelper html, string? controller = null, string? action = null, string? page = null, string? pageController = null, string? cssClass = null)
  {
    ...
    var currentAction = $"{html.ViewContext.RouteData.Values["action"]}";
    var currentController = $"{html.ViewContext.RouteData.Values["controller"]}";
    var currentPage = $"{html.ViewContext.RouteData.Values["page"]}";
    ...
    if (!string.IsNullOrWhiteSpace(pageController))
    {
      ...
      var currentPageController = currentPageList.Count == 2 ? currentPageList[0] : string.Empty;
