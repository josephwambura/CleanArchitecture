...
#nullable enable
  ...
  public async Task SendsEmailGivenEventInstance()
  {
    ...
    _emailSenderMock.Verify(sender => sender.SendEmailAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), CancellationToken.None), Times.Once);
  }
}
